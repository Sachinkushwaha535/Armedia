...
function ServicesPage() {
  ...
  return (
    <>
      ...
      {/* Method */}
      <section className="services-method-section armedia-section-dark border-t border-white/10">
        <div className="armedia-container py-16 lg:py-20">
          <p className="armedia-eyebrow text-brand-gold">How can we help you?</p>
          <h2 className="armedia-heading mt-4 text-white">Method</h2>
          ...
          <div className="mt-10 grid gap-10 border-t border-white/10 pt-10 lg:grid-cols-[1fr_auto] lg:items-start">
            <div>
              <p className="font-heading text-sm font-bold tabular-nums text-brand-gold">
                {String(methodIndex + 1).padStart(2, '0')}
              </p>
              <h3 className="armedia-heading mt-3 text-white">{method.title}</h3>
              <p className="armedia-body mt-4 max-w-2xl text-brand-muted">{method.body}</p>
            </div>
            <Link href="/contact" className="armedia-btn-secondary-light w-fit shrink-0">
              {method.cta}
            </Link>
          </div>
        </div>
