...
const industryLinks = [
  ...
  { label: 'SaaS & tech', href: '/services#digital-media' },
  { label: 'Healthcare', href: '/services' },
  { label: 'Construction', href: '/services' },
]

const socialLinks = [
  socialProfiles.linkedin ? { label: 'LinkedIn', href: socialProfiles.linkedin } : null,
  socialProfiles.instagram ? { label: 'Instagram', href: socialProfiles.instagram } : null,
  socialProfiles.facebook ? { label: 'Facebook', href: socialProfiles.facebook } : null,
    ...
    <footer className="site-footer twg-footer">
      <div className="footer-inner">
        ...
        <div className="twg-footer-top">
          <div className="twg-footer-col twg-footer-col--center">
            ...
            {contactPhone && contactPhoneHref ? (
              <a className="twg-footer-contact" href={contactPhoneHref}>
                {contactPhone}
              </a>
            ) : null}
            <a className="twg-footer-contact" href={`mailto:${contactEmail}`}>
              {contactEmail}
            </a>
          ...
          <div className="twg-footer-col twg-footer-col--center twg-footer-address">
            ...
            <p>
              ...
              <br />
              {businessAddress.addressRegion}, New Zealand
            </p>
            <div className="twg-footer-legal">
              <Link href="/resources/campaign-checklist">Campaign checklist</Link>
        ...
        <div className="footer-bottom twg-footer-bottom">
          <span>
            &copy; 2026 Armedia. Strategy, media, AI, BI, advertising, and growth for New Zealand brands.
          </span>
        </div>
      </div>
    </footer>
